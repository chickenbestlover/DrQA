...
from . import attentionRNN as custom
...
class RnnDocReader(nn.Module):
    ...
    def forward(self, x1, x1_f, x1_pos, x1_ner, x1_mask, x2, x2_mask,x1_order,x2_order):
        ...
        doc_hiddens, question_hidden = self.attention_rnns(drnn_input,x1_mask,x2_emb,x2_mask)
        #print('doc_hiddens:',doc_hiddens.size())
        #print('question_hidden:',question_hidden.size())
